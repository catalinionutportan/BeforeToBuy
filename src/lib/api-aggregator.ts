...
const BASE_PRODUCTS_DB: Product[] = [
  ...
  // --- Photo + Video (Full Digitec-style range) ---
  {
    id: "prod-sony-a7iv",
...
function synthesizeDynamicSearchResults(
  ...
  const inferredCat: string =
    category && category !== ALL_CATEGORIES_ID
      ...
      ? "tv-televisions"
      : q.includes("lens") || q.includes("objektiv") || q.includes("sigma") || q.includes("tamron")
      ? "photo-lenses"
      : q.includes("flash") || q.includes("blitz") || q.includes("godox") || q.includes("speedlight")
      ? "photo-flashes"
      : q.includes("battery") || q.includes("akku") || q.includes("np-fz") || q.includes("lp-e6")
      ? "photo-batteries"
      : q.includes("sd card") || q.includes("memory card") || q.includes("microsd")
      ? "photo-memory"
      : q.includes("tripod") || q.includes("stativ") || q.includes("monopod")
      ? "photo-tripods"
      : q.includes("gimbal") || q.includes("stabilizer") || q.includes("ronin")
      ? "photo-gimbals"
      : q.includes("filter") || q.includes("nd filter") || q.includes("polarizer")
      ? "photo-filters"
      : q.includes("camera bag") || q.includes("peak design") || q.includes("lowepro")
      ? "photo-bags"
      : q.includes("microphone") || q.includes("videomic") || q.includes("rode")
      ? "photo-microphones"
      : q.includes("camera") || q.includes("gopro") || q.includes("mirrorless")
      ? "photo-action"
