...
const BASE_PRODUCTS_DB: Product[] = [
  ...
  },
  {
    ...
    description: "130MB/s read for GoPro, drones, and action cams — includes SD adapter, 10-year warranty.",
    category: "photo-memory",
    brand: "Samsung",
    image: "https://images.unsplash.com/photo-1597872200963-2b64d0879a38?w=600&auto=format&fit=crop&q=80",
    rating: 4.8,
  ...
  },
  {
    ...
    description: "Professional 3-axis gimbal for mirrorless and cinema cameras — automated axis locks, LiDAR AF.",
  ...
  },
  {
    ...
    description: "Carbon-based lens pen, blower, microfiber cloth, and sensor swabs for DSLR/mirrorless maintenance.",
