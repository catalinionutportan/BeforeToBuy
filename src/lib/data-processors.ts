...
const PROCESSOR_PURPOSES: Record<ProcessorRecord["id"], Record<SiteLocale, string>> = {
  ...
  "feed-gigasport-awin": {
    en: "Server-side catalogue import for Gigasport CH",
    de: "Serverseitiger Katalogimport für Gigasport CH",
    fr: "Import catalogue côté serveur pour Gigasport CH",
    it: "Import catalogo lato server per Gigasport CH",
    ro: "Import catalog server-side pentru Gigasport CH",
  },
  "feed-evomag-2p": {
