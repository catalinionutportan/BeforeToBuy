...
export const MERCHANT_FEEDS: FeedConfig[] = [
  ...
  },
  {
    ...
    merchantName: "Belando CH",
    envVar: "AWIN_FEED_URL_CH_BELANDO",
    awinFeedId: "93845",
    awinLanguage: "de",
    sampleFile: "sample-awin-belando-ch.csv",
    sampleFormat: "csv",
    categoryHint: "fashion-beauty-hair-care",
    // ~11k SKUs — warm/import only; never download on visitor requests.
    heavy: true,
    cacheOnly: true,
  },
  {
  ...
  },
  {
    ...
    merchantName: "Gigasport CH",
    envVar: "AWIN_FEED_URL_CH_GIGASPORT",
    awinFeedId: "51705",
    awinLanguage: "de",
    sampleFile: "sample-awin-gigasport-ch.csv",
    sampleFormat: "csv",
    categoryHint: "fashion-men-activewear",
    // ~29k size-variant rows — warm/import only; never download on visitor requests.
    heavy: true,
    cacheOnly: true,
  },
  {
    ...
    merchantName: "Reifen.de",
    envVar: "AWIN_FEED_URL_DE_REIFEN",
    awinFeedId: "93980",
    awinLanguage: "de",
    categoryHint: "auto-tires-wheels",
    heavy: true,
  ...
  },
  {
    ...
    merchantName: "Aqualine.ro",
    envVar: "TWO_PERFORMANT_FEED_URL_RO_AQUALINE",
    categoryHint: "diy-tools-hardware",
    enabled: false,
    heavy: true,
    cacheOnly: true,
  },
  ...
  },
  {
    ...
    country: "GB",
    merchantId: "gb-arlo",
    merchantName: "Arlo Security UK",
    envVar: "AWIN_FEED_URL_GB_ARLO",
    awinFeedId: "112803",
    sampleFile: "sample-awin-arlo-gb.csv",
    sampleFormat: "csv",
    categoryHint: "smart-home-security",
  },
  {
    provider: "AWIN",
    country: "US",
