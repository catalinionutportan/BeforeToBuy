...
export const ALL_MERCHANT_DOMAINS: MerchantDomainInfo[] = [
  ...
  },
  {
    ...
    name: "AutoEco.ro",
    domain: "autoeco.ro",
    websiteUrl: AFFILIATE_LINKS.autoeco2Performant,
    countryCode: "RO",
    affiliateNetwork: "2Performant Romania",
    ...
    badge: "2Performant live · demo prices 🇷🇴",
    description:
      "Romanian auto parts and accessories retailer. Outbound clicks use a live 2Performant affiliate link; price comparison promotion is explicitly allowed by AutoEco program terms. Listed prices remain demo until a product feed is connected.",
  },
  {
    id: "ro-soundhouse",
    name: "Soundhouse.ro",
    domain: "soundhouse.ro",
    websiteUrl: AFFILIATE_LINKS.soundhouse2Performant,
    countryCode: "RO",
    affiliateNetwork: "2Performant Romania",
    ...
    badge: "2Performant live · demo prices 🇷🇴",
    description:
      "Romanian audio and hi-fi retailer. Outbound clicks use a live 2Performant affiliate link; price comparison sites are explicitly allowed by Soundhouse program terms. Listed prices remain demo until a product feed is connected.",
  },
  {
    id: "ro-autobob",
    name: "Autobob.ro",
    domain: "autobob.ro",
    websiteUrl: AFFILIATE_LINKS.autobob2Performant,
    countryCode: "RO",
    affiliateNetwork: "2Performant Romania",
    category: "Auto Parts & Accessories",
    hasClickAndCollect: false,
    ...
    badge: "2Performant live · demo prices 🇷🇴",
    description:
      "Romanian auto parts and accessories retailer. Outbound clicks use a live 2Performant affiliate link; listed prices remain demo until a product feed is connected.",
  },
  {
    id: "ro-automobilus",
    name: "Automobilus.ro",
    domain: "automobilus.ro",
    websiteUrl: AFFILIATE_LINKS.automobilus2Performant,
    countryCode: "RO",
    affiliateNetwork: "2Performant Romania",
    category: "Auto Parts & Accessories",
    hasClickAndCollect: false,
    ...
    badge: "2Performant live · demo prices 🇷🇴",
    description:
      "Romanian auto parts, accessories and car-care retailer. Outbound clicks use a live 2Performant affiliate link; listed prices remain demo until a product feed is connected.",
  },
  {
    id: "ro-paahome",
    name: "PAA-Home.ro",
    domain: "paa-home.ro",
    websiteUrl: AFFILIATE_LINKS.paahome2Performant,
    countryCode: "RO",
    affiliateNetwork: "2Performant Romania",
    ...
    badge: "2Performant live · demo prices 🇷🇴",
    description:
      "Romanian home and living retailer. Outbound clicks use a live 2Performant affiliate link; listed prices remain demo until a product feed is connected.",
  },
  {
    id: "ro-dedeman",
    name: "Dedeman",
...
export const COUNTRIES: Record<CountryCode, CountryInfo> = {
  ...
  RO: {
    ...
    supportedStores: ["emag.ro", "evomag.ro", "rowenta.ro", "scule365.ro", "autoeco.ro", "soundhouse.ro", "autobob.ro", "automobilus.ro", "paa-home.ro", "dedeman.ro"],
    merchantDomains: ALL_MERCHANT_DOMAINS.filter((d) => d.countryCode === "RO"),
    affiliateNetworks: [
      "Profitshare Romania (eMAG) — live",
      "2Performant Romania (evoMAG, Rowenta, Scule365, AutoEco, Soundhouse, Autobob, Automobilus, PAA-Home) — live",
