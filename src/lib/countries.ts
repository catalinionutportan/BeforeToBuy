...
export const COUNTRIES: Record<CountryCode, CountryInfo> = {
  ...
  RO: {
    ...
    supportedStores: ["emag.ro", "evomag.ro", "rowenta.ro", "scule365.ro", "autoeco.ro", "soundhouse.ro", "autobob.ro", "automobilus.ro", "dedeman.ro"],
    merchantDomains: ALL_MERCHANT_DOMAINS.filter((d) => d.countryCode === "RO"),
    affiliateNetworks: [
      "Profitshare Romania (eMAG) — live",
      "2Performant Romania (evoMAG, Rowenta, Scule365, AutoEco, Soundhouse, Autobob, Automobilus) — live",
