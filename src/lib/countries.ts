...
export const ALL_MERCHANT_DOMAINS: MerchantDomainInfo[] = [
  ...
  },
  {
    ...
    name: "MxEnduro.ro",
    domain: "mxenduro.ro",
    websiteUrl: AFFILIATE_LINKS.mxenduro2Performant,
    countryCode: "RO",
    affiliateNetwork: "2Performant Romania",
    category: "Motorsport & Enduro",
    hasClickAndCollect: false,
    status: "Live Affiliate Redirect",
    badge: "2Performant live · demo prices 🇷🇴",
    description:
      "Romanian motorsport / enduro retailer. Outbound clicks use a live 2Performant affiliate link; listed prices remain demo until a product feed is connected.",
  },
  {
    id: "ro-dedeman",
    name: "Dedeman",
