...
export const AFFILIATE_NETWORKS_ACTIVE = [
  ...
  "AWIN Switzerland (baby-walz, Belando, Reifen.com, Acer, Gigasport)",
  "AWIN UK (Seentat, Geepas, Arlo)",
  "AWIN US (Ottocast, DJI)",
] as const;
