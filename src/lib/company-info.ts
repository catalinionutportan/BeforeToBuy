...
export const DATA_PROCESSORS = [
  ...
  { name: "2Performant", purpose: "Affiliate tracking for evoMAG.ro, Rowenta.ro, Scule365.ro, AutoEco.ro, Soundhouse.ro, Autobob.ro and Automobilus.ro outbound links (with Affiliate consent)", region: "RO/EU" },
