...
export const STAGE_ZERO_MONETIZATION = {
  ...
  fr: "BeforeToBuy.com a des redirections d'affiliation limitées en Roumanie : eMAG via Profitshare et evoMAG, Rowenta & Scule365 via 2Performant (avec consentement cookies Affilié). Les autres marchés restent prévus. Nous comparons et redirigeons seulement ; le paiement a toujours lieu chez le marchand. Nous pouvons recevoir une commission — sans frais BeforeToBuy. Les prix affichés restent démo jusqu'aux flux produits.",
