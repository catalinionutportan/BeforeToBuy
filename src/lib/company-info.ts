...
export const DATA_PROCESSORS = [
  ...
  { name: "2Performant", purpose: "Affiliate tracking for evoMAG.ro, Rowenta.ro, Scule365.ro and AutoEco.ro outbound links (with Affiliate consent)", region: "RO/EU" },
