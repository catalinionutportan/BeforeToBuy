...
export const DATA_PROCESSORS = [
  ...
  { name: "2Performant", purpose: "Affiliate tracking for evoMAG.ro and Rowenta.ro outbound links (with Affiliate consent)", region: "RO/EU" },
] as const;
