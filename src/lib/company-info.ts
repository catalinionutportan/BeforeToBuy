...
export const DATA_PROCESSORS = [
  ...
  { name: "2Performant", purpose: "Affiliate tracking for evoMAG.ro, Rowenta.ro and Scule365.ro outbound links (with Affiliate consent)", region: "RO/EU" },
