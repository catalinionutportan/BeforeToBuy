    ...
    feeds: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "Currently configured merchants include Rowenta and Scule365 (2Performant Romania), Seentat (AWIN UK), and Ottocast (AWIN US). evoMAG remains soft-paused in the catalogue (offers hidden without deletion) until image/CDN readiness is confirmed. Affiliate outbound links stay blocked until Affiliate consent is granted. Other merchants are added only after acceptance and feed wiring.",
        },
      ],
    },
    merchants: {
    ...
    feeds: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "Derzeit konfigurierte Händler umfassen Rowenta und Scule365 (2Performant Rumänien), Seentat (AWIN UK) und Ottocast (AWIN US). evoMAG bleibt im Katalog soft-pausiert (Angebote ausgeblendet ohne Löschung), bis Bild-/CDN-Bereitschaft bestätigt ist. Affiliate-Links bleiben gesperrt, bis Affiliate-Einwilligung erteilt wird. Weitere Händler erst nach Freigabe und Feed-Anbindung.",
        },
      ],
    },
    merchants: {
    ...
    feeds: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "I merchant attualmente configurati includono Rowenta e Scule365 (2Performant Romania), Seentat (AWIN UK) e Ottocast (AWIN US). evoMAG resta in soft-pause nel catalogo (offerte nascoste senza cancellazione) finché non è confermata la disponibilità immagini/CDN. I link affiliati restano bloccati fino al consenso Affiliazione. Altri merchant solo dopo accettazione e collegamento del feed.",
        },
      ],
    },
    merchants: {
    ...
    feeds: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "Comercianții configurați momentan includ Rowenta și Scule365 (2Performant România), Seentat (AWIN UK) și Ottocast (AWIN US). evoMAG rămâne soft-paused în catalog (ofertele sunt ascunse fără ștergere) până la confirmarea disponibilității imaginilor/CDN. Linkurile afiliate rămân blocate până la consimțământul Afiliat. Alți comercianți doar după acceptare și conectarea feed-ului.",
        },
      ],
    },
    merchants: {
