    ...
    feeds: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "I merchant attualmente configurati includono baby-walz (AWIN Svizzera), Rowenta e Scule365 (2Performant Romania), Seentat (AWIN UK), Geepas (AWIN UK) e Ottocast (AWIN US). evoMAG resta in soft-pause nel catalogo (offerte nascoste senza cancellazione) finché non è confermata la disponibilità immagini/CDN. I link affiliati restano bloccati fino al consenso Affiliazione. Altri merchant solo dopo accettazione e collegamento del feed.",
        },
      ],
    },
    merchants: {
    ...
    feeds: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "Comercianții configurați momentan includ baby-walz (AWIN Elveția), Rowenta și Scule365 (2Performant România), Seentat (AWIN UK), Geepas (AWIN UK) și Ottocast (AWIN US). evoMAG rămâne soft-paused în catalog (ofertele sunt ascunse fără ștergere) până la confirmarea disponibilității imaginilor/CDN. Linkurile afiliate rămân blocate până la consimțământul Afiliat. Alți comercianți doar după acceptare și conectarea feed-ului.",
        },
      ],
    },
    merchants: {
