    ...
    comparison: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "Default ordering prioritizes useful comparison, including lower listed prices where the current sort and filters allow. We do not guarantee that the lowest listed price is the best total cost after shipping or taxes.",
        },
        {
    ...
    feeds: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "Rowenta and Scule365 via 2Performant, plus Seentat via AWIN, when Affiliate consent is granted. Other merchants are added only after acceptance and feed wiring.",
        },
      ],
    },
    merchants: {
    ...
    feeds: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "Rowenta und Scule365 über 2Performant sowie Seentat über AWIN, wenn Affiliate-Einwilligung erteilt wurde. Weitere Händler werden erst nach Freigabe und Feed-Anbindung ergänzt.",
        },
      ],
    },
    merchants: {
    ...
    feeds: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "Rowenta et Scule365 via 2Performant, ainsi que Seentat via AWIN, lorsque le consentement Affiliation est accordé. Les autres marchands ne sont ajoutés qu'après acceptation et branchement du feed.",
        },
      ],
    },
    merchants: {
    ...
    feeds: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "Rowenta e Scule365 via 2Performant, più Seentat via AWIN, quando viene concesso il consenso Affiliazione. Gli altri merchant vengono aggiunti solo dopo accettazione e collegamento del feed.",
        },
      ],
    },
    merchants: {
    ...
    feeds: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "Rowenta și Scule365 prin 2Performant, plus Seentat prin AWIN, atunci când este acordat consimțământul Afiliat. Ceilalți comercianți sunt adăugați doar după acceptare și conectarea feed-ului.",
        },
      ],
    },
    merchants: {
