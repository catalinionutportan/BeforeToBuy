    ...
    feeds: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "Currently configured merchants include baby-walz and Reifen.com (AWIN Switzerland), Rowenta and Scule365 (2Performant Romania), Seentat (AWIN UK), Geepas (AWIN UK), and Ottocast (AWIN US). evoMAG remains soft-paused in the catalogue (offers hidden without deletion) until image/CDN readiness is confirmed. Affiliate outbound links stay blocked until Affiliate consent is granted. Other merchants are added only after acceptance and feed wiring.",
        },
      ],
    },
    merchants: {
    ...
    feeds: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "Derzeit konfigurierte Händler umfassen baby-walz und Reifen.com (AWIN Schweiz), Rowenta und Scule365 (2Performant Rumänien), Seentat (AWIN UK), Geepas (AWIN UK) und Ottocast (AWIN US). evoMAG bleibt im Katalog soft-pausiert (Angebote ausgeblendet ohne Löschung), bis Bild-/CDN-Bereitschaft bestätigt ist. Affiliate-Links bleiben gesperrt, bis Affiliate-Einwilligung erteilt wird. Weitere Händler erst nach Freigabe und Feed-Anbindung.",
        },
      ],
    },
    merchants: {
    ...
    feeds: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "Les marchands actuellement configurés incluent baby-walz et Reifen.com (AWIN Suisse), Rowenta et Scule365 (2Performant Roumanie), Seentat (AWIN UK), Geepas (AWIN UK) et Ottocast (AWIN US). evoMAG reste en soft-pause dans le catalogue (offres masquées sans suppression) jusqu'à confirmation de la disponibilité image/CDN. Les liens affiliés restent bloqués jusqu'au consentement Affiliation. Les autres marchands sont ajoutés uniquement après acceptation et branchement du feed.",
        },
      ],
    },
    merchants: {
    ...
    feeds: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "I merchant attualmente configurati includono baby-walz e Reifen.com (AWIN Svizzera), Rowenta e Scule365 (2Performant Romania), Seentat (AWIN UK), Geepas (AWIN UK) e Ottocast (AWIN US). evoMAG resta in soft-pause nel catalogo (offerte nascoste senza cancellazione) finché non è confermata la disponibilità immagini/CDN. I link affiliati restano bloccati fino al consenso Affiliazione. Altri merchant solo dopo accettazione e collegamento del feed.",
        },
      ],
    },
    merchants: {
    ...
    feeds: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "Comercianții configurați momentan includ baby-walz și Reifen.com (AWIN Elveția), Rowenta și Scule365 (2Performant România), Seentat (AWIN UK), Geepas (AWIN UK) și Ottocast (AWIN US). evoMAG rămâne soft-paused în catalog (ofertele sunt ascunse fără ștergere) până la confirmarea disponibilității imaginilor/CDN. Linkurile afiliate rămân blocate până la consimțământul Afiliat. Alți comercianți doar după acceptare și conectarea feed-ului.",
        },
      ],
    },
    merchants: {
