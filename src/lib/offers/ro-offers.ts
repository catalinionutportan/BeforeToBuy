...
export async function getRoOffers(product: Product, userLocation: UserLocation, closestStore: any): Promise<Offer[]> {
  ...
  return [
    ...
    },
    {
      ...
      badge: closestStore ? formatUi(`${HOME_UI[DEFAULT_LOCALE].ridicaDin} {branchName} — {distanceKm} ${HOME_UI[DEFAULT_LOCALE].kmAway}`, { branchName: closestStore.branchName, distanceKm: closestStore.distanceKm }) : undefined,
    },
    {
