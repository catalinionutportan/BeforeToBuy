...
export async function getFrOffers(product: Product, userLocation: UserLocation, closestStore: any): Promise<Offer[]> {
  ...
  return [
    ...amazonOffers,
    {
      ...
      currency,
      inStock: true,
      deliveryTime: formatUi(HOME_UI[DEFAULT_LOCALE].retrait1hEnMagasin, {}),
      deliveryCost: 0,
      ...
      badge: closestStore ? formatUi(HOME_UI[DEFAULT_LOCALE].retraitKmAway, { branchName: closestStore.branchName, distanceKm: closestStore.distanceKm }) : undefined,
    },
    {
      ...
      currency,
      inStock: true,
      deliveryTime: formatUi(HOME_UI[DEFAULT_LOCALE].livraison24h, {}),
      deliveryCost: 3.99,
