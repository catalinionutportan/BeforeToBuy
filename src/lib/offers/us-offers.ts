...
export async function getUsOffers(product: Product, userLocation: UserLocation, closestStore: any): Promise<Offer[]> {
  ...
  return [
    ...amazonOffers,
    {
      ...
      currency,
      inStock: true,
      deliveryTime: formatUi(HOME_UI[DEFAULT_LOCALE].storePickupToday, {}),
      deliveryCost: 0,
      ...
      badge: closestStore ? formatUi(HOME_UI[DEFAULT_LOCALE].storePickupKmAway, { distanceKm: closestStore.distanceKm }) : undefined,
    },
  ];
}
