...
export async function getGbOffers(
  ...
  return [
    ...amazonOffers,
    {
      ...
      badge: closestStore ? formatUi(`${ui.collectAt} {branchName} — {distanceKm} ${ui.kmAway}`, { branchName: closestStore.branchName, distanceKm: closestStore.distanceKm }) : undefined,
    },
  ];
}
